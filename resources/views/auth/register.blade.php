...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h2 style="text-align:center;">Registration Form</h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_type" type="text" class="form-control @error('org_type') is-invalid @enderror" name="org_type" placeholder="Vet/Uni" value="{{ old('org_type') }}" required autocomplete="org_type" autofocus>
